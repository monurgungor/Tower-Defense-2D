...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCamera_OnPreRender_mF532865494E97AE563AEBE9B4496C9C1B55E87F4 (PixelPerfectCamera_tAEEA2988EBDE91F2C7D260CDA6B65FB24261CFE8 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		GL_Clear_mF5FCE24D7F60731D6D88AA3DC98B0E88A644CD93((bool)0, (bool)1, L_2, /*hidden argument*/NULL);
	}
...
IL_0019:
	{
		...
		NullCheck(L_3);
		float L_4 = L_3->get_unitsPerPixel_13();
		PixelPerfectRendering_set_pixelSnapSpacing_m2294835A1D269249C71ACE16384E668369FF4919(L_4, /*hidden argument*/NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCamera_OnPostRender_m38D6AE9701187DACFC115503F17C6275AA176D43 (PixelPerfectCamera_tAEEA2988EBDE91F2C7D260CDA6B65FB24261CFE8 * __this, const RuntimeMethod* method)
{
	...
	RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * G_B5_0 = NULL;
	...
	RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * G_B6_1 = NULL;
	{
		...
		PixelPerfectCameraInternal_t95E6E3E3BDA1D90E9F4489ED6B43D1673E0818AB * L_0 = __this->get_m_Internal_13();
		NullCheck(L_0);
		bool L_1 = L_0->get_useOffscreenRT_8();
		if (L_1)
		{
			goto IL_0018;
		}
...
IL_0018:
	{
		...
		L_3 = Camera_get_activeTexture_mD7F968C4D92DF00DB6568A3D7B56DF9C5FEFF15A(L_2, /*hidden argument*/NULL);
		V_0 = L_3;
		// if (activeRT != null)
	...
	}
	{
		...
		NullCheck(L_7);
		bool L_8 = L_7->get_useStretchFill_6();
		G_B4_0 = L_6;
		if (L_8)
		{
			G_B5_0 = L_6;
...
IL_003f:
	{
		NullCheck(G_B6_1);
		Texture_set_filterMode_m045141DB0FEFE496885D45F5F23B15BC0E77C8D0(G_B6_1, G_B6_0, /*hidden argument*/NULL);
	}
...
IL_0044:
	{
		...
		L_15 = PixelPerfectCameraInternal_CalculatePostRenderPixelRect_mB3065A3B8D92AA9C1C21D38B0B4301C7E814C45E(L_10, L_12, L_13, L_14, /*hidden argument*/NULL);
		NullCheck(L_9);
		Camera_set_pixelRect_mB1BFC3EE5DB87F9A66ED0EBFC10B9F80DF1CC61B(L_9, L_15, /*hidden argument*/NULL);
		// }
		return;
	}
}
